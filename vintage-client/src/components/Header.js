...
export default function Header() {
  ...
  return (
    <div id="Header">
      <div
        className={
          get.header.isHeaderHide ? "headerWrapper headerHide" : "headerWrapper"
        }
      >
        <header
          className={get.header.isHeaderExtend ? "headerExtend" : undefined}
        >
          <table></table>
          <img
            className="logo"
          ...
          <div className="functionContainer">
            {get.isLogin ? (
              <p
                ...
                onMouseOver={handleMouseOverFunction}
              >
                로그아웃
              </p>
            ) : (
            ...
            <p onClick={handleClickCart} onMouseOver={handleMouseOverFunction}>
              장바구니
            </p>
            <p onClick={handleClickDibs} onMouseOver={handleMouseOverFunction}>
              찜목록
            </p>
          </div>
          <div className="menuWrapper">
            <p className="menu" onMouseOver={handleMouseOverBrand}>
              BRAND
            </p>

            <p
              className="menu"
              onMouseOver={handleMouseOverNew}
            ...
            <p
              id="man"
              className={get.header.isManShow ? "menu menuShow" : "menu"}
              onMouseEnter={handleMouseEnterMan}
              onClick={handleClickMenu}
            >
              MAN<span className="triangle">▼</span>
            </p>

            <p
              id="woman"
              className={get.header.isWomenShow ? "menu menuShow" : "menu"}
              onMouseEnter={handleMouseEnterWomen}
              onClick={handleClickMenu}
            >
              WOMEN<span className="triangle">▼</span>
            </p>

            <p
              id="acc"
              className={get.header.isAccShow ? "menu menuShow" : "menu"}
              onMouseEnter={handleMouseEnterAcc}
              onClick={handleClickMenu}
            >
              ACC<span className="triangle">▼</span>
            </p>
            ...
            <p
              id="com"
              className={get.header.isComShow ? "menu menuShow" : "menu"}
              onMouseEnter={handleMouseEnterCom}
            >
            ...
            <p
              className="menu"
              onMouseOver={handleMouseOverSale}
              style={{ color: "#f8931f", fontWeight: "bold" }}
      ...
      <div className={get.header.isManShow ? "subMenuShow" : "subMenu"}>
        ...
        ></div>
        <div
          className="subMenuBox manBottom"
          onMouseOver={() => {
            set.setCategory({
              category1: "MAN",
              category2: "BOTTOM",
      ...
      <div className={get.header.isWomenShow ? "subMenuShow" : "subMenu"}>
        <div
          className="subMenuBox womanOuter"
          onMouseOver={() => {
            set.setCategory({
              category1: "WOMAN",
              category2: "OUTER",
        ...
        ></div>
        <div
          className="subMenuBox womanBottom"
          onMouseOver={() => {
            set.setCategory({
              category1: "WOMAN",
              category2: "BOTTOM",
        ...
        ></div>
        <div
          className="subMenuBox womanDress"
          onMouseOver={() => {
            set.setCategory({
              category1: "WOMAN",
              category2: "DRESS",
